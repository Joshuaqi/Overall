package com.yyhh.overall.wight.wowsplash;
...
import com.yyhh.overall.wight.wowsplash.support.SvgPathParser;
...
public class WowSplashView extends View {
    ...
    public WowSplashView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setBackgroundColor(context.getResources().getColor(R.color.material_deepOrange_200));
